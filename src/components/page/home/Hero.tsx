...
export function Hero() {
  return (
    <section id="hero" className="grain hero-vignette relative flex min-h-[90vh] items-end overflow-hidden pb-28 md:min-h-screen md:pb-40 group">
      {/* Background Image */}
      <div className="absolute inset-0 z-0 -top-1/5 bg-linear-to-b from-zinc-800 to-background">
        <Image
          ...
          fill
          priority
          className="object-contain object-center md:object-cover md:object-bottom transition-transform duration-[20s] group-hover:scale-105"
        />
        {/* Lighter gradient just to make text readable, removing the heavy multiply blend */}
